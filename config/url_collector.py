...
class JasmineUrlCollector:
    def __init__(self):
        self.base_url = "https://www.fatsecret.com.br"
        self.search_url = "https://www.fatsecret.com.br/calorias-nutri%C3%A7%C3%A3o/search?q=Jasmine"
        self.headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'
        }
        self.output_file = "dados/jasmine_urls.json"
        self.collected_urls = []
    ...
    def extract_urls_from_page(self, soup):
        ...
        for link in product_links:
            href = link.get('href')
            if href and '/calorias-nutri%C3%A7%C3%A3o/jasmine/' in href:
    ...
    def collect_all_urls(self):
        """Coleta todas as URLs dos produtos da Jasmine Alimentos"""
        print("🔍 Iniciando coleta de URLs dos produtos da Jasmine Alimentos...")
